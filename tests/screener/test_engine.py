...
from engine import _icr_effective, apply_outlier_guard, apply_single_filter
...
def test_icr_debt_free_treated_as_infinity():
    assert _icr_effective(
        {"icr_label": "Debt Free", "interest_coverage": None}
    ) == float("inf")
